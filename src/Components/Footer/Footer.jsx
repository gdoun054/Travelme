      ...
      <div className="contactDiv flex">
       ...
       <div className="footerCard flex">
         ...
         <div className="logoDiv">
          ...
          "Embark on a journey of discovery with us, as we take you on unforgettable adventures to explore the wonders of the world. Our passion for travel drives us to curate extraordinary experiences, ensuring that every step of your adventure is filled with excitement and wonder. Come join us and create memories that will last a lifetime!"
          </div>
         ...
         <div className="footerDiv flex">
           ...
           <small>COPYRIGHTS RESERVED - Ghita Dounia</small>
         </div>
       </div>
