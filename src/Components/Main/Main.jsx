...
const Main = () => {
  ...
  <h1>About Us Page</h1>
  <p>Welcome to Travel, where wanderlust meets exceptional journeys! We are more than just a travel platform; we are your trusted companion in unlocking the wonders of the world. Our mission is to inspire and empower travelers like you to embark on transformative adventures, leaving footprints of unforgettable memories in every destination you explore.</p>
  <p>At Travel, we believe in the power of purposeful travel. Our carefully curated itineraries take you beyond the beaten path, revealing the heart and soul of each destination. Whether you're seeking awe-inspiring landscapes, rich cultural encounters, or adrenaline-pumping escapades, we have something to ignite your wanderlust and make your dreams a reality.</p>
</div>
...
<div className="row">
  <div className="column">
    <div className="card">
      <img src="{toni}" alt="Jane" style={{ width: '100%' }} />
      <div className="container">
        <h2>Jane Doe</h2>
        <p className="title">CEO & Founder</p>
        <p> Le CEO & Founder de "Travel", un leader passionné, guide l'équipe vers l'excellence en offrant une expérience de voyage exceptionnelle.</p>
  ...
  <div className="column">
    <div className="card">
      ...
      <div className="container">
        ...
        <p>Notre talentueux Art Director ajoute une touche artistique remarquable à chaque projet, créant des visuels percutants qui captivent les esprits..</p>
  ...
  <div className="column">
    <div className="card">
      ...
      <div className="container">
        ...
        <p>Nos Designers créent des éléments graphiques saisissants qui enchantent les visiteurs, offrant une expérience visuelle immersive.</p>
